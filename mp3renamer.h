...
#define  FANART_MULTIPLEDISCS             11      /* control type: radioButton, callback function: (none) */
...
#define  PANEL_USEWINAMPALBUMARTIST       21      /* control type: radioButton, callback function: (none) */
#define  PANEL_ID3V1COMMENTS              22      /* control type: radioButton, callback function: (none) */
#define  PANEL_GUESSTITLES                23      /* control type: command, callback function: GuessTitlesCB */
#define  PANEL_RENUMBERBUTTON             24      /* control type: command, callback function: RenumberTracks */
#define  PANEL_TAB                        25      /* control type: tab, callback function: TabCB */
#define  PANEL_TREE                       26      /* control type: tree, callback function: TreeCB */
#define  PANEL_GetMusicBrainzData         27      /* control type: command, callback function: GetMetaDataCB */
#define  PANEL_GETID3BUTTON               28      /* control type: command, callback function: GetID3Tag */
#define  PANEL_ID3BUTTON                  29      /* control type: command, callback function: SetID3Tag */
#define  PANEL_PREVIEWBUTTON              30      /* control type: command, callback function: PreviewNames */
#define  PANEL_FANART                     31      /* control type: command, callback function: RetrieveFanart */
...
#define  PANEL_RENAMEFOLDER               34      /* control type: command, callback function: RenameFolderCB */
#define  PANEL_IMAGERING                  35      /* control type: ring, callback function: ImageRingCB */
#define  PANEL_DLARTWORKBUTTON            36      /* control type: command, callback function: DownloadArtworkCB */
#define  PANEL_QUITBUTTON                 37      /* control type: command, callback function: QuitCallback */
#define  PANEL_EXPLORECURRENT             38      /* control type: command, callback function: ExploreCurrentCB */
#define  PANEL_UPDATEARTIST               39      /* control type: radioButton, callback function: (none) */
#define  PANEL_UPDATEALBUM                40      /* control type: radioButton, callback function: (none) */
#define  PANEL_TRACKNUMLED                41      /* control type: LED, callback function: (none) */
#define  PANEL_DECORATION_2               42      /* control type: deco, callback function: (none) */
#define  PANEL_DECORATION_3               43      /* control type: deco, callback function: (none) */
#define  PANEL_DECORATION                 44      /* control type: deco, callback function: (none) */
#define  PANEL_TEXTMSG                    45      /* control type: textMsg, callback function: (none) */
#define  PANEL_ALBUMLED                   46      /* control type: LED, callback function: (none) */
#define  PANEL_TABVALS2                   47      /* control type: LED, callback function: tabLEDCallback */
#define  PANEL_TABVALS                    48      /* control type: LED, callback function: tabLEDCallback */
#define  PANEL_ARTISTLED                  49      /* control type: LED, callback function: (none) */
#define  PANEL_PICTURE_5                  50      /* control type: picture, callback function: (none) */
#define  PANEL_TRACKNUM                   51      /* control type: string, callback function: (none) */
#define  PANEL_TEXTMSG_2                  52      /* control type: textMsg, callback function: (none) */
#define  PANEL_TEXTMSG_3                  53      /* control type: textMsg, callback function: (none) */
#define  PANEL_VSPLITTER                  54      /* control type: splitter, callback function: (none) */
#define  PANEL_LOG                        55      /* control type: textBox, callback function: (none) */
...
#define  TAB1_ENCODED                     8       /* control type: string, callback function: TagCB */
...
#define  TAB1_UPDATECOMPOSER              25      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATEPUBLISHER             26      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATEENCODED               27      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATECOUNTRY               28      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATERELTYPE               29      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATEALBUMARTIST           30      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATEARTISTFILTER          31      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATEPERFSORT              32      /* control type: radioButton, callback function: (none) */
#define  TAB1_UPDATEALBUMSORT             33      /* control type: radioButton, callback function: (none) */
#define  TAB1_GENRELED                    34      /* control type: LED, callback function: (none) */
#define  TAB1_COMMENTLED                  35      /* control type: LED, callback function: (none) */
#define  TAB1_YEARLED                     36      /* control type: LED, callback function: (none) */
#define  TAB1_UPDATEALBUMGAIN             37      /* control type: radioButton, callback function: (none) */
...
#define  TAB1_COUNTRYLED                  40      /* control type: LED, callback function: (none) */
#define  TAB1_PERFSORTLED                 41      /* control type: LED, callback function: (none) */
#define  TAB1_PUBLISHERLED                42      /* control type: LED, callback function: (none) */
#define  TAB1_ENCODEDLED                  43      /* control type: LED, callback function: (none) */
...
#define  TAB2_URLLED                      8       /* control type: LED, callback function: (none) */
#define  TAB2_CLEARARTWORK                9       /* control type: radioButton, callback function: ClearArtworkCB */
#define  TAB2_UPDATEARTWORK               10      /* control type: radioButton, callback function: (none) */
#define  TAB2_UPDATEURL                   11      /* control type: radioButton, callback function: (none) */
#define  TAB2_ARTWORK                     12      /* control type: picture, callback function: (none) */
#define  TAB2_IMAGECORRUPTEDMSG           13      /* control type: textMsg, callback function: (none) */
#define  TAB2_IMAGESIZEMSG                14      /* control type: textMsg, callback function: (none) */
#define  TAB2_LOADARTWORKBUTTON           15      /* control type: command, callback function: LoadArtworkCB */
#define  TAB2_TEXTMSG                     16      /* control type: textMsg, callback function: (none) */
#define  TAB2_UPDATECOPYRIGHT             17      /* control type: radioButton, callback function: (none) */
#define  TAB2_COPYRIGHTLED                18      /* control type: LED, callback function: (none) */
