...
#ifndef _ID3_LENGTH_T_DEFINED
#define _ID3_LENGTH_T_DEFINED
#ifdef _NI_mswin64_
typedef unsigned __int64    id3_length_t;
#else
typedef unsigned long 		id3_length_t;
#endif
#endif
...
enum {
	...
	ID3_TAG_OPTION_NOPADDING         = 0x1000	/* render tag without padding. Only used to calculate size of tag without padding. */
};
